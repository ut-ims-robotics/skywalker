...
theta_min = np.array([-180, -180, -180, -180, -180, -180  ])*np.pi/180
theta_max = np.array([ 180,  180,  180,  180, 180, 180  ])*np.pi/180 

theta_init = [0,0,0,0,0,0]
desired_pose = Pose()
desired_pose.position.x = 2.555
...
th_ = angle_z
print th_
theta_compute = skywalker_ik.ik(x_base,y_base,z_base,th_,theta_min,theta_max,theta_init,x_desired,y_desired,z_desired,desired_rotation_mat)
print theta_compute
