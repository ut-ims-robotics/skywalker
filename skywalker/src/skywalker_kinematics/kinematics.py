...
for i in range(len(my_data)):
	...
	#ik = inv_kin(desired_pos)
	#print (ik[5])
	#q.append(ik[5])
	#print q
	
	#f = open('joint_angles.csv', 'w')
	#writer = csv.writer(f, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
	#writer.writerows(q)
	joint = th = [ -0.36994320999321495, -0.3721221146644682,-1.1936665838733518, 0.18924615650879684, 2.70414048840186, -1.119628562622295]
	fk = fwd_kin(joint,o_unit='p')
	print(fk)
